...
def openai_generate(openai_input,temperature):
    instruction = ("Provide an answer with references based on the provided abstracts only. Reference answers in square brackets with given abstract ids or file paths from the abstract that was used for that part of the answer. Try to reference each sentence")
